import{a as g,j as e,N as v,s as S,d as j,u as k,b as l,c as y,r as d,e as C,L as P}from"./index-44568db6.js";import{T as w}from"./Title-bb9d294d.js";import{S as F,D,P as L}from"./Pagination-2f163b94.js";import{S as N,a as E,b as z,c as I,d as W,e as T,f as b,g as M}from"./DrinkCard.styled-c08bc89d.js";import{N as B}from"./NotFound-cd6a6e6c.js";import{c as R,a as _,d as $}from"./drinks.selectors-cc3f5dd0.js";const A=({name:a,description:n,alcoholic:c,imgUrl:i,id:r})=>{const h=g(),o=s=>{h(j(s))};return e.jsxs(N,{children:[e.jsx(F,{children:e.jsx(E,{src:i,alt:a})}),e.jsxs("div",{children:[e.jsx(z,{children:a}),e.jsx(I,{children:c})]}),e.jsx(W,{children:n}),e.jsxs(T,{children:[e.jsx(v,{to:`/drink/${r}`,children:e.jsx(b,{children:"See more"})}),e.jsx(M,{onClick:()=>o(r),children:e.jsx("svg",{children:e.jsx("use",{xlinkHref:`${S}#icon-trash`})})})]})]})},H=k.div`
  margin-top: 40px;
  display: flex;
